...
Export your Figma design as a ZIP file using the [Figma to PageGrid Exporter Plugin](https://page-grid.com/docs/figmaimport/), then upload it through the **Setup → Figma to PageGrid** admin page. The module:
